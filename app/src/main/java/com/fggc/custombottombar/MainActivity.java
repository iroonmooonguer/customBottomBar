package com.fggc.custombottombar;
        ...
        homeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedTab != 1) {
                  ...
                  //  homeLayout.setBackgroundColor(getResources().getColor(R.color.round_back_home_100));
        ...
        likeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedTab != 2) {
                    ...
                    //likeLayout.setBackgroundColor(getResources().getColor(R.color.round_back_like_100));
        ...
        notificationLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedTab != 3) {
                   ...
                   // notificationLayout.setBackgroundColor(getResources().getColor(R.color.round_back_notification_100));
        ...
        profileLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedTab != 4) {
                  ...
                  //  profileLayout.setBackgroundColor(getResources().getColor(R.color.round_back_profile_100));
